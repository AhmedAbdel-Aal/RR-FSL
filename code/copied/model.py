...
class Hier_LSTM_CRF_Classifier(nn.Module):
    def __init__(self, n_tags, sent_emb_dim, hidden_dim, sos_tag_idx, eos_tag_idx, pad_tag_idx, device):
        super().__init__()
        ...
        self.emitter = LSTM_Emitter(n_tags, sent_emb_dim, hidden_dim, 0.5, self.device).to(self.device)
